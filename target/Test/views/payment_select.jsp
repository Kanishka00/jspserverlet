...
<%@ page import="Model.AppointmentManagement.Appointment" %>
<%
...
<head>
    ...
    <title>Select Payment Method — Happy Paws</title>
...
<section class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
    <div class="reveal relative">
        ...
        <div class="relative rounded-3xl border border-slate-200 dark:border-slate-800 bg-white/80 dark:bg-slate-900/60 p-6 md:p-7 shadow-soft backdrop-blur">
            ...
            <!-- Form -->
            <form method="post" action="<%= c %>/pay/select" class="mt-6 space-y-5">
                ...
                <div>
                    ...
                    <p class="mt-1 text-xs text-slate-500">If a fee is already set, you can leave this as is.</p>
                </div>
