...
<section class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
  <div class="reveal relative">
    ...
    <div class="relative rounded-3xl border border-slate-200 dark:border-slate-800 bg-white/80 dark:bg-slate-900/60 shadow-soft backdrop-blur overflow-hidden">
      ...
      <form method="post" action="<%= cpath %>/appointments" id="appointmentRequestForm">
      ...
      input.addEventListener('change', function() {
        ...
        if (this.value && this.value !== '') {
          ...
          if (selectedType === 'veterinary') {
            ...
            if (vetBtn) vetBtn.classList.add('bg-blue-100', 'dark:bg-blue-900', 'text-blue-800', 'dark:text-blue-200');
            ...
            if (groomerBtn) groomerBtn.classList.add('bg-blue-100', 'dark:bg-blue-900', 'text-blue-800', 'dark:text-blue-200');
          }
        } else {
