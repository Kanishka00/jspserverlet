  ...
  <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12 reveal">
      <div class="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 p-6 shadow-soft text-center">
        ...
        <p class="text-2xl font-bold text-slate-900 dark:text-slate-100" id="totalProducts">-</p>
      ...
      <div class="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 p-6 shadow-soft text-center">
        ...
        <p class="text-2xl font-bold text-emerald-600" id="todaySales">LKR 0.00</p>
      ...
      <div class="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 p-6 shadow-soft text-center">
        ...
        <p class="text-2xl font-bold text-purple-600" id="monthSales">LKR 0.00</p>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 reveal">
      ...
      <a href="<%= request.getContextPath() %>/sales/list"
         class="group p-6 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 shadow-soft hover:shadow-lg transition-all duration-200">
        <div class="flex items-center gap-4">
...
<script>
  ...
  async function loadDashboardData() {
    ...
    // Set sample sales data (since we don't have a sales API endpoint in this example)
    document.getElementById('todaySales').textContent = 'LKR 15,750.00';
    document.getElementById('monthSales').textContent = 'LKR 285,400.00';
  }
</script>
