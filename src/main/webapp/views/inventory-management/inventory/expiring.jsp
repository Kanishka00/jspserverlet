            ...
            <table class="w-full">
                ...
                %>
                            <tr class="hover:bg-slate-50 dark:hover:bg-slate-800/50">
                                <td class="px-6 py-4">
                                    <%
                                        // Check if product is expired (you may need to implement isExpired() method)
                                        boolean isExpired = false; // Replace with actual expiry check
                                        if (isExpired) {
                                    %>
                                ...
                                <td class="px-6 py-4">
                                    <span class="<%= isExpired ? "text-red-600" : "text-amber-600" %>">
