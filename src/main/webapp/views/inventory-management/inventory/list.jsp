...
<main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 p-6 mb-6 shadow-soft">
        <form method="get" class="flex flex-wrap gap-4 items-end">
            ...
            <a href="<%= request.getContextPath() %>/inventory/list" class="px-4 py-2 border border-slate-300 dark:border-slate-700 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-800">
                Clear
            </a>
        </form>
    </div>
