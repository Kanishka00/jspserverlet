                    ...
                    <div>
                        ...
                        <select id="petUid" name="petUid" required
                            ...
                            <option value="<%= pet.getPetId() %>" 
                                <%= editRecord != null && editRecord.getPetUid().equals(pet.getPetId()) ? "selected" : "" %>>
                    ...
                    <div>
                        ...
                        <select id="staffId" name="staffId" required
                            ...
                            <option value="<%= staff.getStaffId() %>"
                                <%= editRecord != null && editRecord.getStaffId().equals(staff.getStaffId()) ? "selected" : "" %>>
                        ...
                        <tr class="hover:bg-slate-50 dark:hover:bg-slate-800/30">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm">
                                <div class="flex items-center gap-2">
                                    ...
                                    <button type="button" onclick="deleteRecord(<%= record.getRecordId() %>)"
