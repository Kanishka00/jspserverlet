...
public class OwnerPetsServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException {
        ...
        try {
            ...
            // Set success message and reload pets
            req.setAttribute("success", "Pet successfully registered!");
            
            // Reload pets for display
            List<Pet> pets = PetDAO.findByOwner(ownerId);
            req.setAttribute("pets", pets);
            
            RequestDispatcher rd = req.getRequestDispatcher("/views/pet-management/pets.jsp");
            rd.forward(req, res);
